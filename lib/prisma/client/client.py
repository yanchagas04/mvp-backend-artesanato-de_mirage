...
SCHEMA_PATH = Path('F:/Programacao/AltaQualidadeSoftware/mvp-backend-artesanato-de_mirage/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\yanba\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    artesao: 'actions.ArtesaoActions[models.Artesao]'
    produto: 'actions.ProdutoActions[models.Produto]'
    ...
    def __init__(
        ...
        *,
        ...
        self.artesao = actions.ArtesaoActions[models.Artesao](self, models.Artesao)
        self.produto = actions.ProdutoActions[models.Produto](self, models.Produto)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'F:/Programacao/AltaQualidadeSoftware/mvp-backend-artesanato-de_mirage/prisma/schema.prisma',
        }
...
class Batch:
    artesao: 'ArtesaoBatchActions'
    produto: 'ProdutoBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.artesao = ArtesaoBatchActions(self)
        self.produto = ProdutoBatchActions(self)
